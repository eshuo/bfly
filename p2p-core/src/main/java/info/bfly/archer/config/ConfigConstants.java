package info.bfly.archer.config;
...
public class ConfigConstants {
    ...
    public final static class UserSafe {
         ...
         * Ip连续登录失败的次数
         */
        public static final String IP_LOGIN_FAIL_MAX_TIMES = "ip_login_fail_max_times";
        /**
         * 用户连续输入错误密码的最大次数
         */
     ...
     * Package name.
     */
    public final static String Package = "info.bfly.archer.config";
}

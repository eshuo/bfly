...
public class RefundListParam {
    ...
    public RefundListParam(String out_trade_no, String summary, BigDecimal amount, String out_trade_type, String start_time, String end_time) {

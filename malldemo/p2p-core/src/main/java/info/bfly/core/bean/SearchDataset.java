...
public class SearchDataset implements java.io.Serializable {
    // Fields
    private static final long serialVersionUID = 2251150543717526127L;
    ...
    // Property accessors
    @EmbeddedId
    @AttributeOverrides({@AttributeOverride(name = "id", column = @Column(name = "ID", length = 10)), @AttributeOverride(name = "type", column = @Column(name = "TYPE", length = 10)),

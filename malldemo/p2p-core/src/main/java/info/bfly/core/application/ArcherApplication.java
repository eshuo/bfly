...
public class ArcherApplication extends ApplicationWrapper {
    ...
    public Converter createConverter(String converterId) {
        Class<? extends Converter> converterClass = converterIdMap.get(converterId);
        Converter converter = null;
        if (converterClass == null && !converterIdMap.containsKey(converterId)) {
            ...
            if (converterOri != null) {
                ...
                try {
                    // 如果这个对象在spring管理之下，用spring初始化converter
                    converterFromSpring = (Converter) SpringBeanUtil.getBeanByType(converterClass);
                } catch (NoSuchBeanDefinitionException e) {
                }
            ...
            converter = (Converter) SpringBeanUtil.getBeanByType(converterClass);
        }
        return converter;
    }
    ...
    public Validator createValidator(String validatorId) throws FacesException {
        Class<? extends Validator> validatorClass = validatorMap.get(validatorId);
        ...
        if (validatorClass == null && !validatorMap.containsKey(validatorId)) {
            ...
            if (validatorOri != null) {
                ...
                try {
                    ...
                    validatorFromSpring = (Validator) SpringBeanUtil.getBeanByType(validatorClass);
                } catch (NoSuchBeanDefinitionException e) {
                }
            ...
            validator = (Validator) SpringBeanUtil.getBeanByType(validatorClass);
        }
        return validator;
    }

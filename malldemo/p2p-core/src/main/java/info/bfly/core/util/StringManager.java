...
import info.bfly.archer.Constants;
 ...
 * information.
 *
 * @version $Revision: 769384 $ $Date: 2009-04-28 15:14:14 +0200 (Tue, 28 Apr
 *          2009) $
 *
...
public class StringManager {
    ...
    public synchronized static StringManager getManager(String packageName, Locale loc) {
        ...
        if (mgr == null) {
            ...
            StringManager.managers.put(packageName + "_" + loc.toString(), mgr);
        }
        return mgr;
    }
    ...
    /**
     * Get a string from the underlying model bundle or return null if the
     * String is not found.
     *
     * @param key
     *            to desired model String
     * @return model String matching <i>key</i> from underlying bundle or
     *         null if not found.
    ...
    /**
     * Get a string from the underlying model bundle and format it with the

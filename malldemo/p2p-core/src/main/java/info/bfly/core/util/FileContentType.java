...
public class FileContentType {
    public static String getContentType(String filePath) {
        ...
        if (postfix.equalsIgnoreCase(".XLS") || postfix.equalsIgnoreCase(".XLT") || postfix.equalsIgnoreCase(".XLW") || postfix.equalsIgnoreCase(".CSV")) {
        ...
        } else if (postfix.equalsIgnoreCase(".MPA") || postfix.equalsIgnoreCase(".MPE") || postfix.equalsIgnoreCase(".MPEG") || postfix.equalsIgnoreCase(".MPG")) {

...
//@Component
@FacesValidator(value = "info.bfly.core.validator.NotExistValidator")
public class NotExistValidator extends ValueChangeValidator implements PartialStateHolder {
    private static final Logger log = LoggerFactory.getLogger(NotExistValidator.class);
    ...
    public void validateChangedObject(FacesContext context, UIComponent component, Object arg2) throws ValidatorException {
        ...
        if (StringUtils.isNotEmpty(value)) {
            try {
                ...
                if (!alreadyExist) {
                    throw new ValidatorException(MessageFactory.getMessage(context, "info.bfly.core.validator.AlreadyExistValidator.NOT_EXIST", MessageFactory.getLabel(context, component), value));
                }

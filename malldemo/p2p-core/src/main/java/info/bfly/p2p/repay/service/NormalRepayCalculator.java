...
public interface NormalRepayCalculator {
     ...
     * @return 还款数据
     */
    List<Repay> generateRepays(double investMoney, Date investTime, double rate, Integer deadline, String repayTimeUnit, Integer repayTimePeriod, Date interestBeginTime, String interestType,
